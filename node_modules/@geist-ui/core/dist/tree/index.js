...
var TreeFile = function TreeFile(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends({
    ...
    className: styledJsx_cjs.style.dynamic([["4220802947", [level, theme.palette.accents_2, theme.palette.accents_8, theme.palette.accents_5]]]) + " " + (props && props.className != null && props.className || useClasses('file', className) || "")
...
var TreeFolder = function TreeFolder(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _extends({
    ...
    className: styledJsx_cjs.style.dynamic([["1983983326", [parentLevel, theme.palette.accents_2, theme.palette.background, theme.palette.accents_8, theme.palette.accents_5]]]) + " " + (props && props.className != null && props.className || useClasses('folder', className) || "")
  }), /*#__PURE__*/React__default["default"].createElement("div", {
...
var makeChildren = function makeChildren() {
  ...
  return value.sort(function (a, b) {
    ...
    if (item.type === directoryType) return /*#__PURE__*/React__default["default"].createElement(TreeFolder, {
      name: item.name,
      extra: item.extra,
      key: "folder-".concat(item.name, "-").concat(index)
    }, makeChildren(item.files));
    return /*#__PURE__*/React__default["default"].createElement(TreeFile, {
      name: item.name,
      extra: item.extra,
